      ...
      <div className="w-full flex justify-around items-center py-6">
        ...
        <div className="flex justify-start items-center w-[300px]">
          ...
          <div className="ml-4">
            ...
            <p className="text-24 font-semibold text-white">Ξ {props.volume} 
              <span className="ml-2 text-22 font-semibold text-gray-500">$M{Math.round(2493.98 * props.volume/10000)/100}</span>
            </p>            
          </div>
        </div>
        <div className="flex justify-start items-center w-[300px]">
