      ...
      <div className="w-full flex justify-around items-center py-6">
        <div className="flex justify-start items-center w-[300px]">
          ...
          <div className="ml-4">
            ...
            <p className="text-24 font-medium text-white">{props.sale}</p>
          </div>
        </div>
        <div className="flex justify-start items-center w-[300px]">
          ...
          <div className="ml-4">
            ...
            <p className="text-24 font-medium text-white">Ξ {props.volume} 
        ...
        <div className="flex justify-start items-center w-[300px]">
          ...
          <div className="ml-4">
            <p className="text-10 font-bold text-gray-400">Pokemon SOLD</p>
            <p className="text-24 font-medium text-white">{props.sold}</p>
          </div>
        </div>
      </div>
    </>
